    ...
    <div className="max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
        ...
        <input
          ...
          className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F5851E] text-black"
          required
          disabled={isLoading}
        />
        ...
        <button
          type="submit"
          className={`px-4 py-3 bg-[#F5851E] text-white font-semibold rounded-lg shadow-md transition duration-200 ${
            isLoading
